...
public record SetStackAnimationS2CPayload(UUID playerUUID, Identifier controller, Identifier animation, Optional<ItemStack> stack, Hand hand) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, SetStackAnimationS2CPayload> CODEC = PacketCodec.tuple(
            ...
            PacketCodecs.codec(Hand.CODEC), SetStackAnimationS2CPayload::hand,
